...
# Win32
%files -n mingw32-subunit -f mingw32-subunit.lang
...
%files -n mingw32-subunit-static
%{mingw32_libdir}/libexample.a

# Win64
%files -n mingw64-subunit -f mingw64-subunit.lang
...
%files -n mingw64-subunit-static
